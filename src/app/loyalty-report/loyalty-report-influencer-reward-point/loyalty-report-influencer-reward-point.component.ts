...
@Component({
  ...
  templateUrl: './loyalty-report-influencer-reward-point.component.html',
  styleUrls: ['./loyalty-report-influencer-reward-point.component.scss']
})
export class LoyaltyReportInfluencerRewardPointComponent implements OnInit {
  ...
  getSecondaryProductWiseReport(action: any,length) {
    ...
    this.service.post_rqst(this.encryptedData, 'LoyaltyReport/influencer_reward_points').subscribe((result) => {
  ...
  getproductWiseSecondaryReportExcel() {
    ...
    this.service.post_rqst(this.encryptedData, "Reports/excel_influencer_reward_points").subscribe((result) => {
      this.decryptedData = this.service.payLoad ? result : this.cryptoService.decryptData(JSON.stringify(result));
  ...
  downloadExcel2() {
    ...
    if (can == false) {
      ...
      this.service.post_rqst(this.encryptedData, "LoyaltyReport/excel_influencer_reward_points").subscribe((result) => {
        this.decryptedData = this.service.payLoad ? result : this.cryptoService.decryptData(JSON.stringify(result));
        if (this.decryptedData['code'] === 1) {
